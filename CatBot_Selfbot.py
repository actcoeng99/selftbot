...
admin=["uaf35c551ad8a800b3fa1f00a35b6bb4b"]
...
#--------------NOTIFIED_INVITE_INTO_GROUP----------------
	    ...
	    if mid in op.param3:
			...
			cl.cancelGroupInvitation(op.param1, [op.param3])
			cl.sendText(op.param1, "Itu kicker jgn di invite oc bajingan")
		    else:
			pass
...
#--------------------------NOTIFIED_UPDATE_GROUP---------------------
		...
		if op.param2 in admin:
		    pass
                    ...
                    cl.sendText(msg.to, "Jangan mainan QR goblok")
            else:
                pass
#--------------------------SEND_MESSAGE---------------------------
        if op.type == 25:
...
#--------------------------------------------------------
                ...
                cl.sendText(msg.to,"Selamat datang bajingan di "+ gs.name)
#--------------------------------------------------------
	    elif "Bc: " in msg.text:
		bc = msg.text.replace("Bc: ","")
		gid = cl.getGroupIdsJoined()
		for i in gid:
		    cl.sendText(i,"=======[BROADCAST]=======\n\n"+bc+"\n\nContact Me : line.me/ti/p/~@nesawiraguna")
